<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="MasterPage.master" CodeFile="Filelib.aspx.cs" Inherits="Filelib" %>
        	...
        	<div class="col-sm-4" id="infospan" style="display:none">
                ...
                <h4 id="filename"></h4>
               	<div class="btn-group">
                    ...
                    <button type="button" onclick="fileLibThumbFile()" class="btn btn-default">预览</button>
                </div>
            </div>
        </div>
    </div>
