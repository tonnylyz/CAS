/*!
 * bootstrapSwitch JavaScript
 * This file is a standard part of CAS;
 * CAS Version: 6.0.1.1(Beta) Build 20131123;
 * About its modification: True.
 * Line 2432
 */
	...
	function setHeight(height) {
		...
		bodyFirstCells.each(function(i, _cell) {
			if (i < rowCnt) {
				...
				cell.find('> div').css(
					'min-height',
					($(window).height() - 230) / 7//(i==rowCnt-1 ? rowHeightLast : rowHeight) - vsides(cell)
				);
			}
		});
